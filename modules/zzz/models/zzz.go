...
type AgentAttribute struct {
	HP                 float64 `yaml:"hp,omitempty" json:"hp,omitempty"`                                   // 生命值
	Attack             float64 `yaml:"attack,omitempty" json:"attack,omitempty"`                           // 攻击力
	Defense            float64 `yaml:"defense,omitempty" json:"defense,omitempty"`                         // 防御值
	Impact             float64 `yaml:"impact,omitempty" json:"impact,omitempty"`                           // 冲击力
	CriticalRate       float64 `yaml:"critical_rate,omitempty" json:"critical_rate,omitempty"`             // 暴击率
	CriticalDamage     float64 `yaml:"critical_damage,omitempty" json:"critical_damage,omitempty"`         // 暴击伤害
	AnomalyMastery     float64 `yaml:"anomaly_mastery,omitempty" json:"anomaly_mastery,omitempty"`         // 异常掌控
	AnomalyProficiency float64 `yaml:"anomaly_proficiency,omitempty" json:"anomaly_proficiency,omitempty"` // 异常精通
	PenetrationRadio   float64 `yaml:"penetration_radio,omitempty" json:"penetration_radio,omitempty"`     // 穿透率
	Penetration        float64 `yaml:"penetration,omitempty" json:"penetration,omitempty"`                 // 穿透值
	EnergyRegen        float64 `yaml:"energy_regen,omitempty" json:"energy_regen,omitempty"`               // 能量回复
	SheerForce         float64 `yaml:"sheer_force,omitempty" json:"sheer_force,omitempty"`                 // 贯穿力

	// 偏局内加成
	HPBonus      float64 `yaml:"hp_bonus,omitempty" json:"hp_bonus,omitempty"`           // 生命值加成
	DefenseBonus float64 `yaml:"defense_bonus,omitempty" json:"defense_bonus,omitempty"` // 防御力加成
	AttackBonus  float64 `yaml:"attack_bonus,omitempty" json:"attack_bonus,omitempty"`   // 局内攻击加成

	CommonDamageBonus   float64 `yaml:"common_damage_bonus,omitempty" json:"common_damage_bonus,omitempty"`     // 通用伤害加成
	IceDamageBonus      float64 `yaml:"ice_damage_bonus,omitempty" json:"ice_damage_bonus,omitempty"`           // 冰属性伤害加成
	ElectricDamageBonus float64 `yaml:"electric_damage_bonus,omitempty" json:"electric_damage_bonus,omitempty"` // 电属性伤害加成
	PhysicalDamageBonus float64 `yaml:"physical_damage_bonus,omitempty" json:"physical_damage_bonus,omitempty"` // 物理属性伤害加成
	FireDamageBonus     float64 `yaml:"fire_damage_bonus,omitempty" json:"fire_damage_bonus,omitempty"`         // 火属性伤害加成
	EtherDamageBonus    float64 `yaml:"ether_damage_bonus,omitempty" json:"ether_damage_bonus,omitempty"`       // 以太伤害加成

	CommonSheerDamageBonus   float64 `yaml:"common_sheer_damage_bonus,omitempty" json:"common_sheer_damage_bonus,omitempty"`     // 贯穿伤害加成
	IceSheerDamageBonus      float64 `yaml:"ice_sheer_damage_bonus,omitempty" json:"ice_sheer_damage_bonus,omitempty"`           // 贯穿冰属性伤害加成
	ElectricSheerDamageBonus float64 `yaml:"electric_sheer_damage_bonus,omitempty" json:"electric_sheer_damage_bonus,omitempty"` // 贯穿电属性伤害加成
	PhysicalSheerDamageBonus float64 `yaml:"physical_sheer_damage_bonus,omitempty" json:"physical_sheer_damage_bonus,omitempty"` // 贯穿物理属性伤害加成
	FireSheerDamageBonus     float64 `yaml:"fire_sheer_damage_bonus,omitempty" json:"fire_sheer_damage_bonus,omitempty"`         // 贯穿火属性伤害加成
	EtherSheerDamageBonus    float64 `yaml:"ether_sheer_damage_bonus,omitempty" json:"ether_sheer_damage_bonus,omitempty"`       // 贯穿以太伤害加成

	DefenseReduction     float64 `yaml:"defense_reduction,omitempty" json:"defense_reduction,omitempty"`           // 防御减伤
	DamageResistance     float64 `yaml:"damage_resistance,omitempty" json:"damage_resistance,omitempty"`           // 抗性
	StunDamageMultiplier float64 `yaml:"stun_damage_multiplier,omitempty" json:"stun_damage_multiplier,omitempty"` // 失衡易伤
...
//func (a *AgentAttribute) AddEngine(other WeaponEngineInfo) {
//    a.Add(other.OutGame)
//}

type CommonAttribute struct {
	OutGame AgentAttribute `json:"out_game" yaml:"out_game,omitempty"`
	InGame  AgentAttribute `json:"in_game" yaml:"in_game,omitempty"`
	Buff    AgentAttribute `json:"buff" yaml:"buff,omitempty"`
}

type AgentInfo struct {
	Name          string          `yaml:"name"` // 角色名称
	SelfAttribute string          `yaml:"self_attribute"`
	Star          int             `yaml:"-"`
	...
	Buff          AgentAttribute  `yaml:"buff,omitempty"`
...
type TestData struct {
	LevelBase          float64 `json:"level_base"`           // 等级基数
	MonsterBaseDefense float64 `json:"monster_base_defense"` // 怪物基础防御

	DamageMultiplier float64         `json:"damage_multiplier"` // 技能伤害倍率
	Disk             DriverDiskStat  `json:"-"`
	Attribute        CommonAttribute `json:"attribute"`
}

type WeaponEngineInfo struct {
	Name  string         `yaml:"name"`
	Star  int            `yaml:"-"`
	Stars []WeaponEngine `yaml:"stars"`
}
